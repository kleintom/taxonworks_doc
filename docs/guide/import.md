...
Worked examples of DwC Occurrence import behavior, each pairing a minimal test spreadsheet with an automated test asserting exactly what the importer does with it &mdash; grouped by Record level, Occurrence, Collecting Event, Matching, and Settings.

Moved to their own page for readability: see **[Import Specification Examples](/guide/import-specification-examples)**.
